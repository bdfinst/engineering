...
As a product management group, we need to understand the goals that our products
are trying to meet, so that we can measure how close we are to those goals when
we deliver it.
